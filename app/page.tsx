...
function getStatus(count: number): "ok" | "low" | "critical" {
  ...
  const statsDisplay = [
    {
      ...
      value: stats ? `${stats.totalDonors}+` : "—",
    },
    {
      label: "Lives supported",
      value: stats ? `${stats.livesSupported}` : "—",
    },
    {
      label: "Cities covered",
      value: stats ? `${stats.citiesCovered}` : "—",
    },
    {
      label: "Requests right now",
      value: stats ? `${stats.requestsNow}` : "—",
    },
  ];
    ...
    <div className="min-h-screen bg-[#FFF9F4] text-[#211A17] font-sans">
      ...
      <section className="bg-[#211A17] text-[#FFF9F4] text-center px-6 md:px-[6vw] py-20">
        ...
        <p className="text-[#C9BEB5] text-[16px] mb-7">
          Registration takes two minutes. Your next donation could be someone's
          only option.
        </p>
